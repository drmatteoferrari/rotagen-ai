...
import { Copy, Trash2, UserPlus, Send, Users } from "lucide-react";
...
interface Doctor {
  ...
  email: string;
  grade: string;
  surveyStatus: "pending" | "submitted";
}
...
export default function Roster() {
  ...
  const copyMagicLink = (doctor: Doctor) => {
    const link = `${window.location.origin}/doctor/survey?token=${doctor.id}`;
  ...
  const sendSurveys = () => {
    ...
    toast.success(`Survey invites sent to ${pending} doctor${pending !== 1 ? "s" : ""}`);
  };

  const submitted = doctors.filter((d) => d.surveyStatus === "submitted").length;
      ...
      <div className="mx-auto max-w-5xl space-y-6">
          ...
          <Card>
            <CardContent className="flex items-center gap-4 pt-6">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Surveys Submitted</p>
              </div>
            </CardContent>
          </Card>
          <Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Add doctors to this rota period and track their survey progress.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="flex justify-end">
              <Button
                size="lg"
                onClick={sendSurveys}
                disabled={doctors.filter((d) => d.surveyStatus === "pending").length === 0}
              >
