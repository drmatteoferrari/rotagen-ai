...
import { ArrowLeft, ArrowRight, Minus, Plus, CheckCircle, AlertTriangle } from "lucide-react";
    ...
    <AdminLayout title="WTR Setup" subtitle="Step 2 of 4 — Consecutive Shifts">
      <div className="mx-auto max-w-3xl space-y-6">
        ...
        <div className="flex flex-col gap-4">
          {limits.map((item) => (
            <div key={item.label}>
              <div className="rounded-xl bg-card border border-border p-4 shadow-sm flex items-center justify-between">
                ...
                <div className="flex items-center gap-3 bg-muted p-1.5 rounded-lg border border-border">
                  <button
                    className="w-8 h-8 flex items-center justify-center rounded-md bg-card shadow-sm text-muted-foreground hover:text-red-500 transition-all"
