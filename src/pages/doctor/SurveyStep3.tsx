  ...
  const content = (
    <div className="flex flex-col min-h-full">
      ...
      <div className="absolute bottom-0 left-0 w-full bg-white border-t border-slate-200 p-4 pb-8 flex justify-between items-center gap-4 z-20">
        <button onClick={handleBack} className="flex-1 py-4 rounded-xl font-bold text-slate-500 bg-slate-100 hover:bg-slate-200 transition-colors text-center">Back</button>
        <button onClick={handleNext} className="flex-[2] py-4 rounded-xl font-bold text-white bg-teal-500 hover:bg-teal-600 shadow-lg shadow-teal-500/30 flex items-center justify-center gap-2 transition-all">
