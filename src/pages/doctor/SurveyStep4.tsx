  ...
  const content = (
    <div className="flex flex-col min-h-full">
      ...
      <header className="sticky top-0 z-10 flex items-center justify-between bg-white/95 backdrop-blur-sm p-4 pb-2 border-b border-slate-100">
        <button onClick={handleBack} className="flex size-12 items-center justify-center rounded-full text-slate-900 hover:bg-slate-50 transition-colors">
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-white border-t border-slate-100 p-4 z-20">
        <div className="flex gap-4">
          <button onClick={handleBack} className="flex-1 h-12 rounded-xl bg-slate-100 text-slate-900 font-bold hover:bg-slate-200 transition-colors">Back</button>
          <button onClick={handleNext} className="flex-1 h-12 rounded-xl bg-teal-500 text-white font-bold shadow-lg shadow-teal-500/20 hover:bg-teal-600 transition-all flex items-center justify-center gap-2">
