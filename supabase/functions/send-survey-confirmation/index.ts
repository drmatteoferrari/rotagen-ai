...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const subject = `Your rota preferences have been submitted — ${departmentName}, ${rotaStartDate} to ${rotaEndDate}`;
...
<p style="font-size:16px;line-height:1.6;margin:0 0 16px;">Your preference survey has been successfully submitted to RotaEngine.</p>
</td></tr>
...
<tr><td style="color:#666;padding-right:16px;">Submitted:</td><td style="font-weight:600;">${submittedAt}</td></tr>
...
<tr><td style="color:#666;padding-right:16px;">Working pattern:</td><td>${workingPattern}</td></tr>
<tr><td style="color:#666;padding-right:16px;">Annual leave:</td><td>${annualLeaveSummary}</td></tr>
<tr><td style="color:#666;padding-right:16px;">Study leave:</td><td>${studyLeaveSummary}</td></tr>
<tr><td style="color:#666;padding-right:16px;">Prefer not on-call:</td><td>${nocSummary}</td></tr>
<tr><td style="color:#666;padding-right:16px;">Parental leave:</td><td>${parentalLeave}</td></tr>
</table>
</td></tr>
...
<p style="font-size:13px;color:#666;line-height:1.6;margin:0;"><strong>Deadline:</strong> ${surveyDeadline}</p>
</td></tr>

<tr><td style="text-align:center;padding-top:16px;">
<p style="font-size:12px;color:#999;line-height:1.5;margin:0;"><strong>RotaGen</strong> · NHS Rota Management<br/>${departmentName} · ${hospitalName}<br/>This is an automated confirmation — do not reply to this email.</p>
</td></tr>
